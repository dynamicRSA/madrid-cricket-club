...
const en: Translations = {
  ...
  "contact.ground.main": "Main Ground",
  "contact.ground.junior": "Junior Ground",
  "contact.open_maps": "Open in Maps",
  "contact.calendar_rss": "Club Calendar (RSS)",
  "contact.form.coming_desc": "An enquiry form will be wired up once the backend is configured. In the meantime, please email or call the committee directly.",
  ...
  "about.la_elipa_desc": "Our home in Madrid. La Elipa is where we train and run junior cricket. Madrid City Council supports the club with 2 hours/week of subsidised pitch time.",
...
const es: Translations = {
  ...
  "contact.ground.main": "Campo Principal",
  "contact.ground.junior": "Campo Juvenil",
  "contact.open_maps": "Abrir en Maps",
  "contact.calendar_rss": "Calendario del Club (RSS)",
  "contact.form.coming_desc": "Se habilitará un formulario de contacto próximamente. Mientras tanto, escribe o llama al comité directamente.",
  ...
  "about.la_elipa_desc": "Nuestra base en Madrid. La Elipa es donde entrenamos y llevamos a cabo el cricket juvenil. El Ayuntamiento de Madrid nos subvenciona con 2 horas/semana de uso del campo.",
